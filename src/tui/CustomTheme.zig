...
terminal_selection: Theme.Style = .{},
...
pub fn toTheme(self: @This(), allocator: std.mem.Allocator, scope_list: *std.ArrayList([]const u8)) !Theme {
    return .{
        ...
        .terminal_selection = if (self.terminal_selection.fg == null and self.terminal_selection.bg == null) self.editor_selection else self.terminal_selection,
